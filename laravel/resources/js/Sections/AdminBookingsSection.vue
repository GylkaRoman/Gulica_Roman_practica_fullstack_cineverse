    ...
    <div class="min-h-screen flex items-center justify-center text-white">
        <div class="w-full max-w-3xl bg-gray-950 p-8 rounded-2xl shadow-lg">
            ...
            <div class="flex gap-3 mb-6">
                ...
                <select
                    v-model="status"
                    class="p-3 bg-gray-800 rounded-lg text-white"
                >
                ...
                <button
                    @click="fetchBookings"
                    class="bg-primary text-black px-4 py-3 rounded-lg font-bold"
                >
                    Search
                </button>
            </div>
            ...
            <div
                v-for="b in bookings"
                :key="b.id"
                class="bg-gray-800 p-4 mb-3 rounded-lg"
            >
                ...
                <p class="text-sm text-gray-300">
                    {{ b.session.movie.title }} | {{ b.status }} |
                    {{ b.total_price }} MDL
                </p>
            </div>
        </div>
