...
<template>
    <div class="min-h-screen flex items-center justify-center text-white">
        <div class="w-full max-w-3xl bg-gray-950 p-8 rounded-2xl shadow-lg">
            ...
            <div class="grid grid-cols-2 gap-4 mb-6">
                ...
                <div>
                    <input
                        ...
                        @input="clearError('original_title')"
                        placeholder="Original Title"
                        :class="inputClass('original_title')"
                    />
                    <p v-if="errors.original_title" class="error">
                        {{ errors.original_title[0] }}
                    </p>
                </div>
                ...
                <div>
                    ...
                    />
                    <p v-if="errors.genre" class="error">
                        {{ errors.genre[0] }}
                    </p>
                </div>
                ...
                <div>
                    <input
                        ...
                        @input="clearError('age_rating')"
                        placeholder="Age rating"
                        required
                        :class="inputClass('age_rating')"
                    />
                    <p v-if="errors.age_rating" class="error">
                        {{ errors.age_rating[0] }}
                    </p>
                </div>
                ...
                <div>
                    <input
                        ...
                        @input="clearError('director')"
                        placeholder="Director"
                        required
                        :class="inputClass('director')"
                    />
                    <p v-if="errors.director" class="error">
                        {{ errors.director[0] }}
                    </p>
                </div>
                ...
                <div class="col-span-2">
                    <input
                        ...
                        @input="clearError('poster_url')"
                        placeholder="Poster URL"
                        required
                        :class="inputClass('poster_url')"
                    />
                    <p v-if="errors.poster_url" class="error">
                        {{ errors.poster_url[0] }}
                    </p>
                </div>
                ...
                <div class="col-span-2">
                    <input
                        ...
                        @input="clearError('trailer_url')"
                        placeholder="Trailer URL"
                        required
                        :class="inputClass('trailer_url')"
                    />
                    <p v-if="errors.trailer_url" class="error">
                ...
                <div class="col-span-2">
                    <textarea
                        v-model="form.actors"
                        @input="clearError('actors')"
                        placeholder="Actors"
                        required
                        :class="inputClass('actors')"
                    />
                    <p v-if="errors.actors" class="error">
                        {{ errors.actors[0] }}
                    </p>
                </div>
            </div>
            ...
            <button
                @click="editingId ? updateMovie() : createMovie()"
            ...
            >
                ...
                <div class="flex gap-2">
                    <button
                        @click="startEdit(m)"
                        class="bg-green-500 px-3 py-1 rounded text-black"
                    >
                        Edit
                    </button>
                    <button
