...
<template>
    ...
    <main v-if="movie" class="text-white bg-gray-950 min-h-screen font-space">
        ...
        <section class="max-w-6xl mx-auto p-10 grid lg:grid-cols-2 gap-10 items-center">

            <img :src="movie.poster_url" :alt="`${movie.title} movie poster`" loading="lazy" width="400" height="600"
